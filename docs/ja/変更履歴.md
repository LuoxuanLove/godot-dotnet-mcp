...
- v1.4 branch integration、version metadata changes、BOM-prefixed PR headings、formal changelog section requirements に対する release-policy、PR-policy、merge-queue validation coverage を追加しました。

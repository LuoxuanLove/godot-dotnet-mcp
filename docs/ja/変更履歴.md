...
- diagnostics summary resource の redaction を強化し、URL credentials、Bearer token、hyphenated API key、JSON key variants、nested metadata secret が recent MCP log records として client に返る前に伏せられるようにしました。

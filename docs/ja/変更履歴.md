...
- Config tab に Antigravity client guidance を追加しました。app detection、app launch、copied MCP configuration、manual setup directory hints を提供し、documented writable config file contract があるとは仮定しません。

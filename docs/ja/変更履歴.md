...
- `system_editor_control(action=select_popup_menu_item)` を追加し、agent が visible な `PopupMenu` item を index、id、完全一致 text で選択できるようにしました。hidden popup、disabled item、separator、submenu row は拒否します。

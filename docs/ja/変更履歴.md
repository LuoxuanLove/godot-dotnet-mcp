...
- User-tool watch scanning を dedicated scan service に移し、file metadata traversal、slice budgets、scan diagnostics を watch polling / reload coordination から分離しました。

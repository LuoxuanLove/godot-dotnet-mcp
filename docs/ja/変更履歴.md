...
- v2 capability manifest と validator を追加し、static/headless capability が editor-live state、default background process、または scope のない tool call を宣言できないようにしました。

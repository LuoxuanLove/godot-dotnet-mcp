...
- version-policy CI を更新し、v1.4 PR が実際の base branch ref と version metadata を比較するようにしました。release version metadata の変更は引き続き `dev` を対象にする release branch に限定します。

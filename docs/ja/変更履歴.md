...
- tool activity registry と loader contract を拡張し、filtered status / recent query、live running duration、slow-call summary、bounded recent failure summary を検証しました。

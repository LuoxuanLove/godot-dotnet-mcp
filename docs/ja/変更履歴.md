...
- settings-dialog capture contract coverage を拡張し、Project Settings / Editor Settings の popup-first evidence、fallback capture backend、`2026-06-08.18` tool schema facts update を検証するようにしました。

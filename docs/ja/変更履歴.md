...
- v2.0 canonical MCP resources を追加し、guide discovery、project / editor state、activity status / recent read、exposed / visible tool catalog を扱えるようにしました。既存の compatibility resource URI は維持します。
...
- localized v2.0.0 protocol refactor plan を追加し、4 つの localized roadmap から link しました。
...
- localized v2.0.0 protocol plan page の documentation localization validation coverage を追加しました。
- v2.0.0 contract case manifest を追加し、plugin harness の required-case selection を manifest label から派生させました。

...
- missing、malformed、古い major、新しい major、または explicit version-mismatch の editor bridge plugin version からの editor-live upgrade を拒否し、live editor capabilities が compatible v2 bridge を必要とするようにしました。

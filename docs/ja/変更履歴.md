...
- tool list、catalog resource、search result、Tools page rendering が `system_tool_activity` や削除済み scene validation aliases を再公開しないよう removal guard coverage を追加しました。

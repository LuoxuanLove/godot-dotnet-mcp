...
- `system_editor_control` に Project Settings helper を追加し、client が coordinate-based menu automation に頼らず Project Settings を開いて Plugins などの tab を有効化できるようにしました。

### Internal

- tool schema facts を `2026-06-06.1` に更新し、Project Settings の opening と tab activation に対する editor UI harness coverage を拡張しました。

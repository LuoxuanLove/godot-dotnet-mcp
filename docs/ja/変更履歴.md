...
- read-only project file import status inspection を追加し、client が reimport 前に対象 resource が imported、importable だが未 import、missing、または Godot import pipeline 外かを確認できるようにしました。
...
- editor/system project file import-status contract を追加し、新しい read-only import inspection action のため tool schema version を更新しました。

...
- 为 `system_editor_control` 新增项目设置辅助动作，客户端可打开 Project Settings 并激活 Plugins 等标签页，无需依赖坐标式菜单自动化。

### Internal

- 将 tool schema facts 提升到 `2026-06-06.1`，并扩展 editor UI harness 覆盖项目设置打开与标签页激活。

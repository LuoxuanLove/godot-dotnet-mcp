...
| `docs/CHANGELOG.md` / localized changelog entry points | Repository-level version increments and multilingual entry points. They are not part of the plugin package tree |

...
| `impl_settings_dialog.gd` | Implements `system_settings_dialog`, orchestrating settings-like dialog open/status/search/focus/capture/close workflows through editor UI, screenshot, and popup atomic tools without writing setting values |

...
| `impl_settings_dialog.gd` | Implements `system_settings_dialog`, orchestrating settings-like dialog open/status/search/list_categories/focus_category/list_rows/read_value/focus_result/capture/close workflows through editor UI, screenshot, popup, and Tree-item atomic tools without writing setting values |

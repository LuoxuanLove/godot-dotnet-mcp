...
| `impl_settings_dialog.gd` | Implements `system_settings_dialog`, orchestrating settings-like dialog open/status/search/list_tabs/activate_tab/list_rows/read_value/set_value/verify_value/focus/capture/close workflows through editor UI, screenshot, and popup atomic tools with tab navigation, read-only value assertions, and verified UI-scoped value writes |

...
- Hardened diagnostics summary resources so URL credentials, bearer tokens, hyphenated API keys, JSON key variants, and nested metadata secrets are redacted before clients receive recent MCP log records.

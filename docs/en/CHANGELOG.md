...
- Added `system_settings_dialog(action=focus_value)` value-editor focusing for unique visible settings rows so clients can move focus to the editable control without writing setting values.

...
- Added removal guard coverage so tool lists, catalog resources, search results, and Tools page rendering cannot re-expose `system_tool_activity` or the removed scene validation aliases.

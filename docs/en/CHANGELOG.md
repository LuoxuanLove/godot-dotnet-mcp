...
- Changed User-tool watch scanning to use a dedicated scan service, keeping file metadata traversal, slice budgets, and scan diagnostics separate from watch polling and reload coordination.

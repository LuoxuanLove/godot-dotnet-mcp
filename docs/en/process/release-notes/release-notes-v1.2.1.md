...
MCP resource diagnostics now mask mixed-case URL credentials and common sensitive text markers before reporting resource outputs, reducing the chance that credentials appear in diagnostic summaries.

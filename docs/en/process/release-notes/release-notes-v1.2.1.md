...
This development line has been initialized. Before the formal release, this note will be completed from the actual user-visible changes since `v1.2.0`.
...
Agents can now inspect a single project input action through `system_project_configure`, including its deadzone and concrete key, mouse, or controller bindings.

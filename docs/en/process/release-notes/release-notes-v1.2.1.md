...
The Dock Settings update branch picker now keeps long discovered branch lists height-bounded and scrollable, so choosing a development branch no longer covers the editor when many refs are available.

...
| Each `*_contract_test.gd` | Single-case file, split by module |
...
| `config_feature_config_workflow_contracts` | Verify write and remove confirmation, success prompts, noop removal, and post-run follow-up prompts in `config_feature_config_workflow.gd` |

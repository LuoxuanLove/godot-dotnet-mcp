...
<p align="center"><a href="../../../README.md">English</a> | <a href="README.md">日本語</a> | <a href="../zh-CN/README.md">简体中文</a></p>
...
| 📚 | **MCP Resources と Prompts** | プロジェクトリソース、診断読み取り入口、一般的な Godot ワークフロー向け Prompt Guide を提供します。 |

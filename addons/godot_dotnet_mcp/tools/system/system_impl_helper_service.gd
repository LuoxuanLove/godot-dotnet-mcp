...
func collect_files(filter: String) -> Array:
	return _execution_service.collect_files(filter, _atomic_caller())


func collect_file_count(filter: String) -> int:
	return _execution_service.collect_file_count(filter, _atomic_caller())


func collect_file_counts(filters: Array) -> Dictionary:
	return _execution_service.collect_file_counts(filters, _atomic_caller())

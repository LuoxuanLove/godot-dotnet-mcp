...
func _init() -> void:
	...
	for impl_name in ["impl_help", "impl_catalog", "impl_activity", "impl_project", "impl_editor", "impl_settings_dialog", "impl_scene", "impl_script", "impl_index", "impl_runtime", "impl_dap"]:

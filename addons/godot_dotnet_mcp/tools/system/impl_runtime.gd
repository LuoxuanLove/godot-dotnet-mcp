...
func configure_runtime(context: Dictionary) -> void:
	...
	MCPDebugBuffer.record("info", "system", "impl_runtime configure_runtime runtime_service=%s" % str(_runtime_control_service != null))
...
func execute(tool_name: String, args: Dictionary) -> Dictionary:
	...
	match tool_name:
		"runtime_control":
			return _execute_runtime_control_sync(args)
...
func execute_async(tool_name: String, args: Dictionary) -> Dictionary:
	...
	match tool_name:
		"runtime_control":
			return await _execute_runtime_control_async(args)
		"runtime_capture":
			return await _execute_runtime_capture(args)
		"runtime_input":
			return await _execute_runtime_input(args)
		"runtime_step":
...
func _execute_runtime_control_sync(args: Dictionary) -> Dictionary:
...
func _execute_runtime_control_async(args: Dictionary) -> Dictionary:
	var action := str(args.get("action", "")).strip_edges()
	match action:
		"status":
			return _success(_build_runtime_status(), "Runtime control status fetched")
...
func _execute_runtime_capture(args: Dictionary) -> Dictionary:
...
func _execute_runtime_input(args: Dictionary) -> Dictionary:

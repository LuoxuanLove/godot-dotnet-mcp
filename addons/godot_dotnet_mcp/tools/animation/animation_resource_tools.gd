...
## Animation resource tools for Godot MCP
...
func _create_animation(player: AnimationPlayer, anim_name: String, length: float) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "name": anim_name, "length": length}, "Animation created")
...
func _delete_animation(player: AnimationPlayer, anim_name: String) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "name": anim_name}, "Animation deleted")
...
func _duplicate_animation(player: AnimationPlayer, anim_name: String, new_name: String) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "original": anim_name, "duplicate": new_name}, "Animation duplicated")
...
func _rename_animation(player: AnimationPlayer, anim_name: String, new_name: String) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "old_name": anim_name, "new_name": new_name}, "Animation renamed")
...
func _set_animation_length(player: AnimationPlayer, anim_name: String, length: float) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "name": anim_name, "length": length}, "Animation length set")
...
func _set_animation_loop(player: AnimationPlayer, anim_name: String, loop: bool) -> Dictionary:
	...
	return _success({"path": _get_scene_path(player), "name": anim_name, "loop": loop}, "Animation loop set")

...
const SUPPLEMENTAL_TRANSLATIONS: Dictionary = {
	"en": {
		...
		"bridge_install_status_label": "Install State:",
		...
		"bridge_install_installed": "Ready",
		"bridge_install_invalid": "Invalid",
		"bridge_install_missing": "Missing file",
		"bridge_install_select_button": "Select Bridge Exe",
		...
		"bridge_install_selected": "Bridge executable registered.",
		"bridge_install_validation_failed": "Bridge validation failed.",
		"bridge_install_cleared": "Bridge registration cleared.",
	...
	"zh_CN": {
		...
		"bridge_install_installed": "可用",
		"bridge_install_invalid": "无效",
		"bridge_install_missing": "文件缺失",
		...
		"bridge_install_selected": "Bridge 可执行文件已注册。",
		"bridge_install_validation_failed": "Bridge 验证失败。",
		"bridge_install_cleared": "Bridge 注册已清除。",

...
func build_model(context: Dictionary) -> Dictionary:
	...
	return {
		...
		"update_refs_release_rows": context.get("update_refs_release_rows", []),
		"update_refs_branch_commit_rows": context.get("update_refs_branch_commit_rows", {}),
		"update_refs_last_trigger": str(context.get("update_refs_last_trigger", "")),
		"update_refs_last_requested_unix": int(context.get("update_refs_last_requested_unix", 0)),
		"update_refs_last_http_status": int(context.get("update_refs_last_http_status", 0)),
		"update_refs_rate_limit_remaining": str(context.get("update_refs_rate_limit_remaining", "")),
		"update_refs_rate_limit_reset_unix": int(context.get("update_refs_rate_limit_reset_unix", 0)),
		"update_refs_rate_limit_retry_after": int(context.get("update_refs_rate_limit_retry_after", 0)),
		"update_refs_audit": context.get("update_refs_audit", {}),
		...
		"update_selected_target_kind": str(context.get("update_selected_target_kind", "")),
		"update_selected_target_ref": str(context.get("update_selected_target_ref", "")),
		"update_selected_target_commit": str(context.get("update_selected_target_commit", "")),

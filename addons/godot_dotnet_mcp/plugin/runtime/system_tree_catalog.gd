...
const SYSTEM_TOOL_ATOMIC_CHILDREN := {
	...
	"system_editor_control": [
		...
		{"tool": "editor_ui_control",  "actions": ["list_visible", "list_dock_tabs", "activate_dock_tab", "activate_ui", "list_menus", "open_menu", "select_menu_item", "open_project_settings", "activate_project_settings_tab", "get_control", "capture_control", "focus_control", "activate_control", "click_control", "right_click_control", "hover_control", "leave_control", "set_text"]},

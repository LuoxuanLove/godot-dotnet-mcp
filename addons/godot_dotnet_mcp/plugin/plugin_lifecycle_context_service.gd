...
func build_plugin_lifecycle_context(plugin, constants: Dictionary) -> Dictionary:
	return {
		...
		"install_performance_monitors": _plugin_callable(plugin, "_install_performance_monitors"),
		...
		"remove_performance_monitors": _plugin_callable(plugin, "_remove_performance_monitors"),

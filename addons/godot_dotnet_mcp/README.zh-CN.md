...
![Godot .NET MCP 工具页](https://raw.githubusercontent.com/LuoxuanLove/godot-dotnet-mcp/refs/heads/dev/asset_library/tools-cn.png)
...
- `/health` 返回正常
- `/api/tools` 能返回工具列表
- `resources/list`、`godot-dotnet-mcp://guides/index` 与 `prompts/list` 能返回当前能力、资源入口和工作流引导

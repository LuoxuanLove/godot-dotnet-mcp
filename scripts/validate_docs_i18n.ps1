...
$docMap = @(
    ...
    @{ Id = "contract-v3-bridge-upgrade"; Paths = @{ en = "contracts/v3-bridge-upgrade-contract.md"; "zh-CN" = "契约/v3-bridge-upgrade-contract.md"; ja = "契約/v3-bridge-upgrade-contract.md"; ko = "계약/v3-bridge-upgrade-contract.md" } },
    ...
    @{ Id = "process-release-notes-v3.0.0"; Paths = @{ en = "process/release-notes/release-notes-v3.0.0.md"; "zh-CN" = "流程/发布说明/发布说明-v3.0.0.md"; ja = "プロセス/リリースノート/リリースノート-v3.0.0.md"; ko = "프로세스/릴리스-노트/릴리스-노트-v3.0.0.md" } },

...
Invoke-PolicyScenario -Name "current predevelopment base unchanged metadata" -BaseBranch "v2.0" -HeadBranch "feature/v3-tooling" -HeadVersion "1.0.0" -ShouldPass $true
Invoke-PolicyScenario -Name "v3 release baseline stacked base unchanged metadata" -BaseBranch "release/v3.0.0-baseline" -HeadBranch "feature/v3-session-contracts" -HeadVersion "1.0.0" -ShouldPass $true
Invoke-PolicyScenario -Name "v3 feature stacked base unchanged metadata" -BaseBranch "feature/v3-resource-reference-graph" -HeadBranch "feature/v3-session-lifecycle-contract" -HeadVersion "1.0.0" -ShouldPass $true
Invoke-PolicyScenario -Name "v3 docs stacked base unchanged metadata" -BaseBranch "docs/v3-contract-hardening-release-notes" -HeadBranch "ci/v3-release-companion-gates" -HeadVersion "1.0.0" -ShouldPass $true
Invoke-PolicyScenario -Name "non-v3 stacked base rejected" -BaseBranch "feature/random-base" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, v3.0, or an explicit v3 stacked base branch"
Invoke-PolicyScenario -Name "v30 stacked base rejected" -BaseBranch "feature/v30-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, v3.0, or an explicit v3 stacked base branch"
Invoke-PolicyScenario -Name "v3x stacked base rejected" -BaseBranch "feature/v3x-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, v3.0, or an explicit v3 stacked base branch"
Invoke-PolicyScenario -Name "v3 bare stacked base rejected" -BaseBranch "feature/v3" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, v3.0, or an explicit v3 stacked base branch"
Invoke-PolicyScenario -Name "hotfix v3 stacked base rejected" -BaseBranch "hotfix/v3-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, v3.0, or an explicit v3 stacked base branch"
...
Invoke-PolicyScenario -Name "current predevelopment base non-release changed metadata" -BaseBranch "v2.0" -HeadBranch "feature/v3-version" -HeadVersion "3.0.0" -ShouldPass $false -ExpectedErrorContains "Non-release branch 'feature/v3-version' changes public version metadata"
Invoke-PolicyScenario -Name "v3 stacked base non-release changed metadata" -BaseBranch "feature/v3-resource-reference-graph" -HeadBranch "feature/v3-version" -HeadVersion "3.0.0" -ShouldPass $false -ExpectedErrorContains "Non-release branch 'feature/v3-version' changes public version metadata"
...
Invoke-PolicyScenario -Name "release branch can target v2 base" -BaseBranch "v2.0" -HeadBranch "release/v3.0.0-baseline" -HeadVersion "3.0.0" -RequireTrustedReleaseBranch -ShouldPass $true
Invoke-PolicyScenario -Name "release branch cannot target v3 stacked base" -BaseBranch "feature/v3-resource-reference-graph" -HeadBranch "release/v3.0.0-baseline" -HeadVersion "3.0.0" -RequireTrustedReleaseBranch -ShouldPass $false -ExpectedErrorContains "Release version changes must target dev, v2.0, or v3.0"
Invoke-PolicyScenario -Name "release branch cannot target refactor base" -BaseBranch "refactor/v1.4.0" -HeadBranch "release/v1.1.0" -HeadVersion "1.1.0" -RequireTrustedReleaseBranch -ShouldPass $false -ExpectedErrorContains "Release version changes must target dev, v2.0, or v3.0"

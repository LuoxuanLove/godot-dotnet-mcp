...
Invoke-PolicyScenario -Name "non-v2 stacked base rejected" -BaseBranch "feature/random-base" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, or a v2 stacked base branch"
Invoke-PolicyScenario -Name "v20 stacked base rejected" -BaseBranch "feature/v20-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, or a v2 stacked base branch"
Invoke-PolicyScenario -Name "v2x stacked base rejected" -BaseBranch "feature/v2x-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, or a v2 stacked base branch"
Invoke-PolicyScenario -Name "v2 bare stacked base rejected" -BaseBranch "feature/v2" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, or a v2 stacked base branch"
Invoke-PolicyScenario -Name "hotfix v2 stacked base rejected" -BaseBranch "hotfix/v2-policy" -HeadBranch "feature/tooling" -HeadVersion "1.0.0" -ShouldPass $false -ExpectedErrorContains "expects pull requests to target dev, refactor/v1.4.0, v2.0, or a v2 stacked base branch"
...
Invoke-PolicyScenario -Name "release branch cannot target refactor base" -BaseBranch "refactor/v1.4.0" -HeadBranch "release/v1.1.0" -HeadVersion "1.1.0" -RequireTrustedReleaseBranch -ShouldPass $false -ExpectedErrorContains "Release version changes must target dev or v2.0"

...
Invoke-PolicyScenario -Name "v1.4 refactor baseline changed metadata" -BaseBranch "refactor/v1.4.0" -HeadBranch "chore/v1.4-version-baseline" -HeadVersion "1.4.0" -ShouldPass $true
Invoke-PolicyScenario -Name "fork v1.4 refactor baseline changed metadata" -BaseBranch "refactor/v1.4.0" -HeadBranch "chore/v1.4-version-baseline" -HeadVersion "1.4.0" -HeadRepositoryOwner "external-user" -ShouldPass $false -ExpectedErrorContains "v1.4 refactor baseline version changes must come from the base repository"

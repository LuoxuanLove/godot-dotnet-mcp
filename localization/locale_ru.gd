...
const TRANSLATIONS: Dictionary = {
	...
	"tool_profile_slim_desc": "Включает только основные инструменты проверки и редактирования, которые чаще всего нужны в проектах Godot.NET.",
	"tool_profile_default_desc": "Рекомендуемый профиль для повседневной работы. Сохраняет основные, игровые, анимационные и UI-инструменты.",

...
const TRANSLATIONS: Dictionary = {
	...
	"btn_restart": "再起動",
	"btn_reload_plugin": "プラグインを完全に再読み込み",
	"tool_profile": "プリセット:",
	"tool_profile_slim": "スリム",
	"tool_profile_default": "標準",
	"tool_profile_full": "完全",
	"tool_profile_slim_desc": "Godot.NET プロジェクトで最もよく使う基礎確認・編集ツールとプラグイン実行時ツールのみを有効にします。",
	"tool_profile_default_desc": "日常利用向けの推奨プリセットです。基礎、プラグイン、ゲームプレイ、ビジュアル/アニメーション、UI ツールを維持します。",
	"tool_profile_full_desc": "登録済みのすべてのツールカテゴリを有効にします。",
	"tool_profile_custom_desc": "カスタムプリセット: %s",
	"tool_profile_modified_desc": "現在の選択は変更されています。[追加] でカスタムプリセットとして保存できます。",
	"tool_profile_save_title": "カスタムツールプリセットを保存",
	"tool_profile_save_desc": "現在のツール選択を再利用可能なカスタムプリセットファイルとして保存します。",
	...
	"btn_add_profile": "追加",
	"btn_save_profile": "保存",
	"tools_server_unavailable": "サーバーを利用できません。スクリプト読み込みエラーはエディター出力を確認してください。",
	...
	"tool_scene_run_name": "実行",
	"tool_scene_bindings_desc": "シーンで使われているエクスポート済みスクリプトのバインディングを確認",
	"tool_scene_audit_desc": "エクスポート済みバインディングから導かれるシーンの問題を報告",
	"tool_node_query_name": "検索",
	"tool_node_lifecycle_name": "ライフサイクル",
	"tool_node_transform_name": "変換",
	"tool_node_property_name": "プロパティ",
	"tool_node_hierarchy_name": "階層",
	"tool_node_signal_name": "シグナル",
	"tool_node_group_name": "グループ",
	"tool_node_process_name": "処理",
	"tool_node_metadata_name": "メタデータ",
	"tool_node_call_name": "呼び出し",
	"tool_node_visibility_name": "可視性",
	"tool_node_physics_name": "物理",
	"tool_resource_query_name": "検索",
	...
	"tool_project_autoload_name": "自動読み込み",
	"tool_script_read_name": "読み取り",
	"tool_script_open_name": "開く",
	"tool_script_inspect_name": "解析",
	"tool_script_symbols_name": "シンボル",
	"tool_script_exports_name": "エクスポート",
	"tool_script_edit_gd_name": "GDScript 編集",
	"tool_script_read_desc": "スクリプトファイルをプレーンテキストとして読み取る",
	"tool_script_inspect_desc": "GDScript と C# のスクリプトメタデータを解析",
	"tool_script_symbols_desc": "解析されたクラス、メソッド、エクスポート、列挙を一覧表示",
	"tool_script_exports_desc": "スクリプトで宣言されたエクスポートメンバーを一覧表示",
	"tool_script_edit_gd_desc": "構造化ヘルパーで GDScript ファイルを編集",
	"tool_editor_status_name": "状態",
	"tool_editor_settings_name": "設定",
	"tool_editor_undo_redo_name": "元に戻す/やり直し",
	...
	"tool_debug_class_db_name": "クラス DB",
	...
	"tool_animation_player_name": "プレイヤー",
	...
	"tool_material_material_name": "マテリアル",
	"tool_material_mesh_name": "メッシュ",
	"tool_shader_shader_name": "シェーダー",
	"tool_shader_shader_material_name": "シェーダーマテリアル",
	"tool_lighting_light_name": "ライト",
	"tool_lighting_environment_name": "環境",
	"tool_lighting_sky_name": "空",
	"tool_particle_particles_name": "パーティクル",
	"tool_particle_particle_material_name": "パーティクルマテリアル",
	...
	"tool_physics_collision_shape_name": "コリジョン形状",
	...
	"tool_audio_player_name": "プレイヤー",
	"tool_ui_theme_name": "テーマ",
	"tool_ui_control_name": "コントロール",
	"tool_signal_signal_name": "シグナル",

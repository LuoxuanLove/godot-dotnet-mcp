...
const TRANSLATIONS: Dictionary = {
	...
	"tool_profile_slim_desc": "Active seulement les outils principaux d'inspection et d'édition les plus utilisés dans les projets Godot.NET.",
	"tool_profile_default_desc": "Profil recommandé au quotidien. Conserve les outils cœur, gameplay, animation et interface.",

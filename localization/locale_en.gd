...
const TRANSLATIONS: Dictionary = {
	...
	"cat_script_desc": "Script reading, inspection, symbols and GDScript editing helpers.",
	...
	"cat_project_desc": "Project info, settings, input map and autoload configuration.",
	...
	"cat_debug_desc": "Logging, debug buffer, profiler and performance inspection tools.",

...
const TRANSLATIONS: Dictionary = {
	...
	"tool_profile_slim_desc": "Aktiviert nur die wichtigsten Prüf- und Bearbeitungswerkzeuge für Godot.NET-Projekte.",
	"tool_profile_default_desc": "Empfohlen für den Alltag. Behält Kern-, Gameplay-, Animations- und UI-Werkzeuge bei.",

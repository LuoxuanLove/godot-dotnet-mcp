...
func run_case(tree: SceneTree) -> Dictionary:
	...
	if FileAccess.file_exists("res://addons/godot_dotnet_mcp/tools/shader_tools.gd.uid"):
		return _failure("shader_tools.gd.uid should be removed with the legacy shader monolith.")

...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	if MCPProtocolFacts.get_tool_schema_version() != "2026-06-08.26":
		return _failure("system help contract should cover the current canonical resources schema version.")

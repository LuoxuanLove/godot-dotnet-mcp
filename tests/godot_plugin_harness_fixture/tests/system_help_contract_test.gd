...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	if MCPProtocolFacts.get_tool_schema_version() != "2026-06-08.22":
		return _failure("system help contract should cover the current plugin maintenance schema version.")

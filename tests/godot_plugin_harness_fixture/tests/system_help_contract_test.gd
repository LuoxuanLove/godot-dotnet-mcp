...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	if MCPProtocolFacts.get_tool_schema_version() != "2026-06-08.27":
		return _failure("system help contract should cover the current structured tool result schema version.")

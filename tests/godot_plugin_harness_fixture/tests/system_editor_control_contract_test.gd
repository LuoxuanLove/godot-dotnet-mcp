...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	for expected_action in ["list_main_screens", "get_distraction_free", "set_distraction_free", "wait_for_ui", "list_tree_items", "select_tree_item", "select_popup_menu_item", "hover_control", "leave_control", "set_value"]:

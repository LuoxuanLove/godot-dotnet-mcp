...
func _verify_plugin_entrypoint_delegates_update_refs_discovery() -> String:
	...
	for required_service in [
		...
		"func increment_commit_history_page(pending: Dictionary, head_commit: String)",
		"func mark_commit_history_failed(pending: Dictionary, head_commit: String)",
		"func are_commit_histories_done(pending: Dictionary)",

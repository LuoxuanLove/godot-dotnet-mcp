...
func run_case(tree: SceneTree) -> Dictionary:
	...
	if _find_label_containing(labels, "Selected target:") == null:
		return _failure("Settings tab should display the selected update target in status copy.")

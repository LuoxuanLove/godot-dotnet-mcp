...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	if FileAccess.file_exists("res://addons/godot_dotnet_mcp/tools/project_tools.gd.uid"):
		return _failure("project_tools.gd.uid should be removed with the legacy project monolith.")

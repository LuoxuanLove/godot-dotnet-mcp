...
func run_case(_tree: SceneTree) -> Dictionary:
	...
	if PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_ref_branches") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_ref_releases") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_ref_versions") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_refs_state") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_refs_refresh_state") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_refs_last_checked_unix") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_sync_state") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_compare_state") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_compare_refresh_state") or PluginRuntimeStateScript.DEFAULT_SETTINGS.has("update_compare_last_checked_unix"):

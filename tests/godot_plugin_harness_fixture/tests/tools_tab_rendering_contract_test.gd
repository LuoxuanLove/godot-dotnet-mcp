...
func _system_actions_for(full_name: String) -> Array:
	match full_name:
		...
		"system_editor_control":
			return ["set_main_screen", "capture_editor", "list_controls", "list_dock_tabs", "activate_dock_tab", "activate_ui", "get_control", "capture_control", "focus_control", "activate_control", "click_control", "right_click_control", "set_control_text", "list_popups", "press_popup_button", "select_popup_menu_item", "set_popup_text", "close_popup"]

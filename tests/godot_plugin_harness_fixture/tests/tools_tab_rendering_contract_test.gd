...
func _system_actions_for(full_name: String) -> Array:
	match full_name:
		...
		"system_settings_dialog":
			return ["open", "status", "search", "list_tabs", "activate_tab", "list_categories", "focus_category", "list_rows", "read_value", "set_value", "verify_value", "focus_result", "capture", "close"]
